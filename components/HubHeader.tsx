  ...
  return (
    <footer>
      <div className="container footer-top">
        <div><BrandLogo footer /><p>เพื่อนคู่คิดด้านทะเบียน บัญชี ภาษี<br />และใบอนุญาตสำหรับผู้ประกอบการไทย</p><div className="footer-contact-links"><a href="https://lin.ee/rNBJrQF" target="_blank" rel="noreferrer"><span>LINE</span><strong>@tangton</strong></a><div><span>WeChat</span><strong>@tangton</strong></div></div></div>

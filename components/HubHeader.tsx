  ...
  return (
    <footer>
      <div className="container footer-top">
        <div><BrandLogo footer /><p>เพื่อนคู่คิดด้านทะเบียน บัญชี ภาษี<br />และใบอนุญาตสำหรับผู้ประกอบการไทย</p><div className="footer-contact-links"><a href="https://lin.ee/rNBJrQF" target="_blank" rel="noreferrer"><span>LINE</span><strong>@tangton</strong></a><div><span>WeChat</span><strong>@tangton</strong></div><a className="footer-brand-contact telegram" href="https://t.me/tangton" target="_blank" rel="noreferrer"><img src="/contact-icons/telegram.svg" alt="" width="18" height="18" /><span><small>Telegram</small><strong>@tangton</strong></span></a><a className="footer-brand-contact whatsapp" href="https://wa.me/66815199922" target="_blank" rel="noreferrer" aria-label="เปิดแชต WhatsApp"><img src="/contact-icons/whatsapp.svg" alt="" width="18" height="18" /><span><small>WhatsApp</small><strong>เปิดแชต</strong></span></a></div></div>

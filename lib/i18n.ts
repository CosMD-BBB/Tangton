...
export const dictionaries = {
  en: {
    ...
    faq: { eyebrow: "Frequently asked questions", title: "20 answers for starting and running a business in Thailand", lead: "Practical answers for foreign founders about Thai company registration, foreign ownership, VAT, accounting, registered addresses, licences, company changes and closure." },
    footer: "Multilingual business registration and administration support for founders in Thailand.", copyright: "© 2026 Tangton — All rights reserved" },
  my: {
    ...
    faq: { eyebrow: "မေးလေ့ရှိသောမေးခွန်းများ", title: "ထိုင်းနိုင်ငံတွင် လုပ်ငန်းစတင်ရန် အရေးကြီးသော အဖြေ ၂၀", lead: "နိုင်ငံခြားသားလုပ်ငန်းရှင်များအတွက် ကုမ္ပဏီမှတ်ပုံတင်ခြင်း၊ နိုင်ငံခြားပိုင်ဆိုင်မှု၊ VAT၊ စာရင်းကိုင်၊ လိပ်စာ၊ လိုင်စင်၊ ကုမ္ပဏီပြောင်းလဲခြင်းနှင့် ပိတ်သိမ်းခြင်းဆိုင်ရာ လက်တွေ့အဖြေများ။" },
    footer: "ထိုင်းနိုင်ငံရှိ လုပ်ငန်းရှင်များအတွက် ဘာသာစကားမျိုးစုံဖြင့် မှတ်ပုံတင်ခြင်းနှင့် စီမံခန့်ခွဲမှု ပံ့ပိုးမှု။", copyright: "© 2026 Tangton — မူပိုင်ခွင့်အားလုံး လက်ဝယ်ရှိသည်" },
  hi: {
    ...
    faq: { eyebrow: "सामान्य प्रश्न", title: "थाईलैंड में व्यवसाय शुरू करने और चलाने के 20 महत्वपूर्ण उत्तर", lead: "विदेशी संस्थापकों के लिए थाई कंपनी पंजीकरण, विदेशी स्वामित्व, VAT, लेखांकन, पंजीकृत पता, लाइसेंस, कंपनी परिवर्तन और बंद करने की व्यावहारिक जानकारी।" },
    footer: "थाईलैंड में उद्यमियों के लिए बहुभाषी व्यवसाय पंजीकरण और प्रशासन सहायता।", copyright: "© 2026 Tangton — सर्वाधिकार सुरक्षित" },
  zh: {
    ...
    faq: { eyebrow: "常见问题", title: "在泰国设立和经营企业的 20 个重要解答", lead: "面向外国创业者，涵盖泰国公司注册、外资持股、VAT、会计、注册地址、行业许可证、公司变更及注销等常见问题。" },
    footer: "为在泰国创业者提供多语言企业注册与行政支持。", copyright: "© 2026 Tangton — 版权所有" },
} as const;

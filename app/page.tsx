...
export default function Home() {
  return <>
    ...
    <main>
      ...
      <section className="section reviews-section"><div className="container review-layout"><div className="review-intro"><p className="eyebrow light"><span /> ตัวอย่างรูปแบบรีวิว</p><h2>ความน่าเชื่อถือ<br />ต้องมีที่มา<br /><em>และตรวจสอบได้</em></h2><p>เพิ่มภาพประกอบให้เห็นบุคลิกของเจ้าของธุรกิจชัดขึ้น โดยพื้นที่นี้จะเปลี่ยนเป็นภาพลูกค้าจริง ชื่อธุรกิจ วันที่ใช้บริการ และแหล่งอ้างอิงก่อนเปิดใช้งานจริง</p><div className="review-policy"><span aria-hidden="true">✓</span><p><strong>ไม่ใช้รีวิวที่ตรวจสอบไม่ได้</strong><small>ข้อความและภาพด้านขวาเป็นตัวอย่างการจัดวางเท่านั้น</small></p></div></div><div className="review-cards">
        <article><figure className="review-photo left"><img src="/review-portraits-v10.png" alt="ภาพประกอบตัวอย่างผู้ประกอบการหญิง" width="1774" height="887" loading="lazy" decoding="async" /><figcaption>ภาพประกอบรูปแบบรีวิว</figcaption></figure><div className="review-body"><div className="review-rating"><span aria-label="5 ดาว">★★★★★</span><small>ตัวอย่างรีวิว</small></div><div className="quote" aria-hidden="true">“</div><p>เห็นทั้งราคา เอกสาร และขั้นตอนก่อนคุย ทำให้รู้ว่าควรถามอะไรและไม่ต้องเริ่มจากศูนย์</p><div className="reviewer"><span className="review-avatar"><img src="/review-portraits-v10.png" alt="" width="1774" height="887" loading="lazy" decoding="async" /></span><div><strong>คุณเมย์</strong><small>เจ้าของแบรนด์สินค้าเพื่อสุขภาพ • ตัวอย่างตำแหน่งรีวิว</small></div></div></div></article>
        <article><figure className="review-photo right"><img src="/review-portraits-v10.png" alt="ภาพประกอบตัวอย่างผู้ประกอบการชาย" width="1774" height="887" loading="lazy" decoding="async" /><figcaption>ภาพประกอบรูปแบบรีวิว</figcaption></figure><div className="review-body"><div className="review-rating"><span aria-label="5 ดาว">★★★★★</span><small>ตัวอย่างรีวิว</small></div><div className="quote" aria-hidden="true">“</div><p>เครื่องมือช่วยคำนวณและเก็บเช็กลิสต์ได้จริง พอคุยกับทีมจึงส่งข้อมูลได้ครบกว่าเดิม</p><div className="reviewer"><span className="review-avatar"><img src="/review-portraits-v10.png" alt="" width="1774" height="887" loading="lazy" decoding="async" /></span><div><strong>คุณนนท์</strong><small>ผู้ก่อตั้งสตูดิโอออกแบบ • ตัวอย่างตำแหน่งรีวิว</small></div></div></div></article>
      </div></div></section>

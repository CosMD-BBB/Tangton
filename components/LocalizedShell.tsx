...
export function LocalizedFooter({ locale }: { locale: Locale }) {
  ...
  return <footer lang={t.htmlLang}><div className="container footer-top localized-footer">
    <div><BrandLogo locale={locale} href={p()} footer /><p>{t.footer}</p><div className="footer-contact-links"><a href="https://lin.ee/rNBJrQF" target="_blank" rel="noreferrer"><span>LINE</span><strong>@tangton</strong></a><div><span>WeChat</span><strong>@tangton</strong></div></div></div>

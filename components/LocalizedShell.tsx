...
export function LocalizedFooter({ locale }: { locale: Locale }) {
  ...
  return <footer lang={t.htmlLang}><div className="container footer-top localized-footer">
    <div><BrandLogo locale={locale} href={p()} footer /><p>{t.footer}</p><div className="footer-contact-links"><a className="footer-brand-contact line" href="https://lin.ee/rNBJrQF" target="_blank" rel="noreferrer"><img src="/contact-icons/line.svg" alt="" width="18" height="18" /><span><small>LINE</small><strong>@tangton</strong></span></a><div className="footer-brand-contact wechat"><img src="/contact-icons/wechat.svg" alt="" width="18" height="18" /><span><small>WeChat</small><strong>@tangton</strong></span></div><a className="footer-brand-contact telegram" href="https://t.me/tangton" target="_blank" rel="noreferrer"><img src="/contact-icons/telegram.svg" alt="" width="18" height="18" /><span><small>Telegram</small><strong>@tangton</strong></span></a><a className="footer-brand-contact whatsapp" href="https://wa.me/66815199922" target="_blank" rel="noreferrer" aria-label="Open WhatsApp chat"><img src="/contact-icons/whatsapp.svg" alt="" width="18" height="18" /><span><small>WhatsApp</small><strong>Open chat</strong></span></a></div></div>
